            ...
            switch ((int) (Math.random() * METHODS) + 1) {
                case 1:
                    ...
                    if (satiety > 0) {
                        num++;
                        myArray[0] = " Играл ";
                        System.out.println(num + myArray[0]);
                    } else {
                        satiety++;
                        num++;
                        System.out.println(num + " Поктик поел " + satiety);
                    }
                case 2:
                    sleep();
                    if (satiety > 0) {
                        num++;
                        myArray[1] = " Спал ";
                        System.out.println(num + myArray[2]);
                    } else {
                        satiety++;
                        num++;
                        System.out.println(num + " Поктик поел " + satiety);
                ...
                case 4:
                    ...
                    if (satiety > 0) {
                        num++;
                        myArray[3] = " Гулял ";
                        System.out.println(num + myArray[3]);
                    } else {
                        satiety++;
                        num++;
                        System.out.println(num + " Поктик поел " + satiety);
                ...
                case 5:
                    ...
                    if (satiety > 0) {
                        num++;
                        myArray[4] = " Охотился ";
                        System.out.println(num + myArray[4]);
                    } else {
                        num++;
                        satiety++;
                        System.out.println(num + " Поктик поел " + satiety);
                ...
                default:
                    ...
                    myArray[5] = " Ел ";
                    satiety++;
                    System.out.println(num + myArray[5]);
            }
